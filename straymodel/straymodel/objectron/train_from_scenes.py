...
from straymodel.data.stray_data_module import SceneData
from pytorch_lightning.callbacks import ModelCheckpoint
from straymodel.objectron.objectron import Objectron
    

@click.command()
@click.option('--scenes-dir', default=None)
...
def train(scenes_dir, batch_size, num_workers, num_epochs,
    ...
    datamodule = SceneData([os.path.join(scenes_dir, scene) for scene in os.listdir(scenes_dir) if os.path.isdir(os.path.join(scenes_dir, scene))], batch_size=batch_size, num_workers=num_workers)
